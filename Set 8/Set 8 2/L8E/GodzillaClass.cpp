...
//getters
const string Godzilla::getName(){ //getting original name
    return name;
}

const double Godzilla::getHealth(){ //getting original health
    return health;
}

const double Godzilla::getPower(){ //getting original power
    return power;
}
...
void Godzilla::greet(const Godzilla &g){
    //making Godzilla be cordial
    cout << name << " bows to " << g.name << endl; //output fro cordial Godzilla
}
